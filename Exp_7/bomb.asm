...
08049509 <phase_2>:
 ...
 8049513:	6a 08                	push   $0x8
 8049515:	8d 45 d4             	lea    -0x2c(%ebp),%eax
 8049518:	50                   	push   %eax
 8049519:	ff 75 08             	push   0x8(%ebp)
 804951c:	e8 fc 05 00 00       	call   8049b1d <read_n_numbers>
 ...
 804952f:	8b 45 d4             	mov    -0x2c(%ebp),%eax
 8049532:	3d 8a 00 00 00       	cmp    $0x8a,%eax
 8049537:	74 0c                	je     8049545 <phase_2+0x3c>
 8049539:	e8 01 09 00 00       	call   8049e3f <explode_bomb>
 804953e:	b8 00 00 00 00       	mov    $0x0,%eax
 8049543:	eb 4a                	jmp    804958f <phase_2+0x86>
 8049545:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
 804954c:	eb 36                	jmp    8049584 <phase_2+0x7b>
 804954e:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8049551:	8b 54 85 d4          	mov    -0x2c(%ebp,%eax,4),%edx // edx = A[i]
 8049555:	8b 45 f4             	mov    -0xc(%ebp),%eax // eax = i =1 
 8049558:	83 e8 01             	sub    $0x1,%eax // eax = i - 1 = 0
 804955b:	8b 4c 85 d4          	mov    -0x2c(%ebp,%eax,4),%ecx // ecx = A[i-1]
 804955f:	8b 5d f4             	mov    -0xc(%ebp),%ebx // ebx = i = 1
 8049562:	b8 00 00 00 00       	mov    $0x0,%eax // eax = 0
 8049567:	29 d8                	sub    %ebx,%eax // eax = eax - ebx = 0 -1 =-1
 8049569:	01 c0                	add    %eax,%eax eax = - 2
 804956b:	01 c8                	add    %ecx,%eax 138 - 2 =136
 804956d:	83 c0 01             	add    $0x1,%eax 
 8049570:	39 c2                	cmp    %eax,%edx
 8049572:	74 0c                	je     8049580 <phase_2+0x77>
 8049574:	e8 c6 08 00 00       	call   8049e3f <explode_bomb>
 8049579:	b8 00 00 00 00       	mov    $0x0,%eax
 804957e:	eb 0f                	jmp    804958f <phase_2+0x86>
 8049580:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 8049584:	83 7d f4 07          	cmpl   $0x7,-0xc(%ebp)
 8049588:	7e c4                	jle    804954e <phase_2+0x45>
...
08049594 <phase_3>:
 ...
 80495a8:	8d 45 e8             	lea    -0x18(%ebp),%eax
 80495ab:	50                   	push   %eax
 80495ac:	8d 45 ec             	lea    -0x14(%ebp),%eax
 80495af:	50                   	push   %eax
 80495b0:	68 bd a1 04 08       	push   $0x804a1bd
 80495b5:	ff 75 08             	push   0x8(%ebp)
 80495b8:	e8 13 fb ff ff       	call   80490d0 <__isoc99_sscanf@plt>
 80495bd:	83 c4 10             	add    $0x10,%esp
 80495c0:	89 45 f0             	mov    %eax,-0x10(%ebp)
 80495c3:	83 7d f0 01          	cmpl   $0x1,-0x10(%ebp)
 80495c7:	7f 0f                	jg     80495d8 <phase_3+0x44>
 ...
 80495d8:	8b 45 ec             	mov    -0x14(%ebp),%eax
 80495db:	83 e8 07             	sub    $0x7,%eax
 80495de:	83 f8 09             	cmp    $0x9,%eax
 80495e1:	77 63                	ja     8049646 <phase_3+0xb2>
 80495e3:	8b 04 85 c4 a1 04 08 	mov    0x804a1c4(,%eax,4),%eax
 80495ea:	ff e0                	jmp    *%eax
 80495ec:	c7 45 f4 9c 03 00 00 	movl   $0x39c,-0xc(%ebp)
 80495f3:	eb 5d                	jmp    8049652 <phase_3+0xbe>
 80495f5:	c7 45 f4 9c 03 00 00 	movl   $0x39c,-0xc(%ebp)
 80495fc:	eb 54                	jmp    8049652 <phase_3+0xbe>
 80495fe:	c7 45 f4 cd 03 00 00 	movl   $0x3cd,-0xc(%ebp)
 8049605:	eb 4b                	jmp    8049652 <phase_3+0xbe>
 8049607:	c7 45 f4 9c 03 00 00 	movl   $0x39c,-0xc(%ebp)
 804960e:	eb 42                	jmp    8049652 <phase_3+0xbe>
 8049610:	c7 45 f4 cd 03 00 00 	movl   $0x3cd,-0xc(%ebp)
 8049617:	eb 39                	jmp    8049652 <phase_3+0xbe>
 8049619:	c7 45 f4 9c 03 00 00 	movl   $0x39c,-0xc(%ebp)
 8049620:	eb 30                	jmp    8049652 <phase_3+0xbe>
 8049622:	c7 45 f4 cd 03 00 00 	movl   $0x3cd,-0xc(%ebp)
 8049629:	eb 27                	jmp    8049652 <phase_3+0xbe>
 804962b:	c7 45 f4 cd 03 00 00 	movl   $0x3cd,-0xc(%ebp)
 8049632:	eb 1e                	jmp    8049652 <phase_3+0xbe>
 8049634:	c7 45 f4 9c 03 00 00 	movl   $0x39c,-0xc(%ebp)
 804963b:	eb 15                	jmp    8049652 <phase_3+0xbe>
 804963d:	c7 45 f4 cd 03 00 00 	movl   $0x3cd,-0xc(%ebp)
 ...
 8049652:	8b 45 e8             	mov    -0x18(%ebp),%eax
 8049655:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 8049658:	74 0c                	je     8049666 <phase_3+0xd2>
...
0804966d <func4>:
 ...
 8049673:	8b 45 10             	mov    0x10(%ebp),%eax
 8049676:	2b 45 0c             	sub    0xc(%ebp),%eax
 8049679:	89 c2                	mov    %eax,%edx
 804967b:	c1 ea 1f             	shr    $0x1f,%edx
 804967e:	01 d0                	add    %edx,%eax
 8049680:	d1 f8                	sar    $1,%eax
 8049682:	89 c2                	mov    %eax,%edx
 ...
 804968f:	3b 45 08             	cmp    0x8(%ebp),%eax
 8049692:	7e 23                	jle    80496b7 <func4+0x4a>
 8049694:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8049697:	83 e8 01             	sub    $0x1,%eax
 804969a:	83 ec 04             	sub    $0x4,%esp
 804969d:	50                   	push   %eax
 804969e:	ff 75 0c             	push   0xc(%ebp)
 80496a1:	ff 75 08             	push   0x8(%ebp)
 80496a4:	e8 c4 ff ff ff       	call   804966d <func4>
 80496a9:	83 c4 10             	add    $0x10,%esp
 80496ac:	89 c2                	mov    %eax,%edx
 80496ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80496b1:	d1 f8                	sar    $1,%eax
 80496b3:	01 d0                	add    %edx,%eax
 80496b5:	eb 2e                	jmp    80496e5 <func4+0x78>
 80496b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80496ba:	3b 45 08             	cmp    0x8(%ebp),%eax
 80496bd:	7d 23                	jge    80496e2 <func4+0x75>
 80496bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80496c2:	83 c0 01             	add    $0x1,%eax
 80496c5:	83 ec 04             	sub    $0x4,%esp
 80496c8:	ff 75 10             	push   0x10(%ebp)
 80496cb:	50                   	push   %eax
 80496cc:	ff 75 08             	push   0x8(%ebp)
 80496cf:	e8 99 ff ff ff       	call   804966d <func4>
 80496d4:	83 c4 10             	add    $0x10,%esp
 80496d7:	89 c2                	mov    %eax,%edx
 80496d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
...
080496e7 <phase_4>:
 ...
 80496ed:	8d 45 e8             	lea    -0x18(%ebp),%eax
 80496f0:	50                   	push   %eax
 80496f1:	8d 45 ec             	lea    -0x14(%ebp),%eax
 80496f4:	50                   	push   %eax
 80496f5:	68 bd a1 04 08       	push   $0x804a1bd
 80496fa:	ff 75 08             	push   0x8(%ebp)
 80496fd:	e8 ce f9 ff ff       	call   80490d0 <__isoc99_sscanf@plt>
 8049702:	83 c4 10             	add    $0x10,%esp
 8049705:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049708:	83 7d f4 02          	cmpl   $0x2,-0xc(%ebp)
 804970c:	75 10                	jne    804971e <phase_4+0x37>
 804970e:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8049711:	83 f8 03             	cmp    $0x3,%eax
 8049714:	7e 08                	jle    804971e <phase_4+0x37>
 8049716:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8049719:	83 f8 30             	cmp    $0x30,%eax
 804971c:	7e 0c                	jle    804972a <phase_4+0x43>
 804971e:	e8 1c 07 00 00       	call   8049e3f <explode_bomb>
 8049723:	b8 00 00 00 00       	mov    $0x0,%eax
 8049728:	eb 2f                	jmp    8049759 <phase_4+0x72>
 804972a:	8b 45 ec             	mov    -0x14(%ebp),%eax
 804972d:	83 ec 04             	sub    $0x4,%esp
 8049730:	6a 30                	push   $0x30
 8049732:	6a 04                	push   $0x4
 8049734:	50                   	push   %eax
 8049735:	e8 33 ff ff ff       	call   804966d <func4>
 804973a:	83 c4 10             	add    $0x10,%esp
 804973d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8049740:	8b 45 e8             	mov    -0x18(%ebp),%eax
 8049743:	39 45 f0             	cmp    %eax,-0x10(%ebp)
 8049746:	74 0c                	je     8049754 <phase_4+0x6d>
...
0804975b <phase_5>:
 ...
 8049761:	8d 45 e4             	lea    -0x1c(%ebp),%eax
 8049764:	50                   	push   %eax
 8049765:	8d 45 e8             	lea    -0x18(%ebp),%eax
 8049768:	50                   	push   %eax
 8049769:	68 bd a1 04 08       	push   $0x804a1bd
 804976e:	ff 75 08             	push   0x8(%ebp)
 8049771:	e8 5a f9 ff ff       	call   80490d0 <__isoc99_sscanf@plt>
 8049776:	83 c4 10             	add    $0x10,%esp
 8049779:	89 45 ec             	mov    %eax,-0x14(%ebp)
 804977c:	83 7d ec 01          	cmpl   $0x1,-0x14(%ebp)
 8049780:	7f 0c                	jg     804978e <phase_5+0x33>
 8049782:	e8 b8 06 00 00       	call   8049e3f <explode_bomb>
 8049787:	b8 00 00 00 00       	mov    $0x0,%eax
 804978c:	eb 57                	jmp    80497e5 <phase_5+0x8a>
 804978e:	8b 45 e8             	mov    -0x18(%ebp),%eax
 8049791:	83 e0 0f             	and    $0xf,%eax
 8049794:	89 45 e8             	mov    %eax,-0x18(%ebp)
 8049797:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 804979e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 80497a5:	eb 17                	jmp    80497be <phase_5+0x63>
 80497a7:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 80497ab:	8b 45 e8             	mov    -0x18(%ebp),%eax
 80497ae:	8b 04 85 e0 c1 04 08 	mov    0x804c1e0(,%eax,4),%eax
 80497b5:	89 45 e8             	mov    %eax,-0x18(%ebp)
 80497b8:	8b 45 e8             	mov    -0x18(%ebp),%eax
 80497bb:	01 45 f0             	add    %eax,-0x10(%ebp)
 80497be:	8b 45 e8             	mov    -0x18(%ebp),%eax
 80497c1:	83 f8 0f             	cmp    $0xf,%eax
 80497c4:	75 e1                	jne    80497a7 <phase_5+0x4c>
 80497c6:	83 7d f4 07          	cmpl   $0x7,-0xc(%ebp)
 80497ca:	75 08                	jne    80497d4 <phase_5+0x79>
 80497cc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 80497cf:	39 45 f0             	cmp    %eax,-0x10(%ebp)
 80497d2:	74 0c                	je     80497e0 <phase_5+0x85>
...
080497e7 <phase_6>:
 ...
 80497ed:	c7 45 e8 1c c1 04 08 	movl   $0x804c11c,-0x18(%ebp)
 80497f4:	83 ec 04             	sub    $0x4,%esp
 80497f7:	6a 07                	push   $0x7
 80497f9:	8d 45 cc             	lea    -0x34(%ebp),%eax
 80497fc:	50                   	push   %eax
 80497fd:	ff 75 08             	push   0x8(%ebp)
 8049800:	e8 18 03 00 00       	call   8049b1d <read_n_numbers>
 8049805:	83 c4 10             	add    $0x10,%esp
 8049808:	85 c0                	test   %eax,%eax
 804980a:	75 0a                	jne    8049816 <phase_6+0x2f>
 804980c:	b8 00 00 00 00       	mov    $0x0,%eax
 8049811:	e9 37 01 00 00       	jmp    804994d <phase_6+0x166>
 8049816:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 804981d:	eb 60                	jmp    804987f <phase_6+0x98>
 804981f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8049822:	8b 44 85 cc          	mov    -0x34(%ebp,%eax,4),%eax
 8049826:	85 c0                	test   %eax,%eax
 8049828:	7e 0c                	jle    8049836 <phase_6+0x4f>
 804982a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 804982d:	8b 44 85 cc          	mov    -0x34(%ebp,%eax,4),%eax
 8049831:	83 f8 07             	cmp    $0x7,%eax
 8049834:	7e 0f                	jle    8049845 <phase_6+0x5e>
 ...
 8049848:	83 c0 01             	add    $0x1,%eax
 804984b:	89 45 ec             	mov    %eax,-0x14(%ebp)
 804984e:	eb 25                	jmp    8049875 <phase_6+0x8e>
 8049850:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8049853:	8b 54 85 cc          	mov    -0x34(%ebp,%eax,4),%edx
 8049857:	8b 45 ec             	mov    -0x14(%ebp),%eax
 804985a:	8b 44 85 cc          	mov    -0x34(%ebp,%eax,4),%eax
 804985e:	39 c2                	cmp    %eax,%edx
 8049860:	75 0f                	jne    8049871 <phase_6+0x8a>
 ...
 8049871:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
 8049875:	83 7d ec 06          	cmpl   $0x6,-0x14(%ebp)
 8049879:	7e d5                	jle    8049850 <phase_6+0x69>
 804987b:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 804987f:	83 7d f0 06          	cmpl   $0x6,-0x10(%ebp)
 8049883:	7e 9a                	jle    804981f <phase_6+0x38>
 8049885:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 804988c:	eb 36                	jmp    80498c4 <phase_6+0xdd>
 804988e:	8b 45 e8             	mov    -0x18(%ebp),%eax
 8049891:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049894:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
 804989b:	eb 0d                	jmp    80498aa <phase_6+0xc3>
 804989d:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80498a0:	8b 40 08             	mov    0x8(%eax),%eax
 80498a3:	89 45 f4             	mov    %eax,-0xc(%ebp)
 80498a6:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
 80498aa:	8b 45 f0             	mov    -0x10(%ebp),%eax
 80498ad:	8b 44 85 cc          	mov    -0x34(%ebp,%eax,4),%eax
 80498b1:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 80498b4:	7c e7                	jl     804989d <phase_6+0xb6>
 80498b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 80498b9:	8b 55 f4             	mov    -0xc(%ebp),%edx
 80498bc:	89 54 85 b0          	mov    %edx,-0x50(%ebp,%eax,4)
 80498c0:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 80498c4:	83 7d f0 06          	cmpl   $0x6,-0x10(%ebp)
 80498c8:	7e c4                	jle    804988e <phase_6+0xa7>
